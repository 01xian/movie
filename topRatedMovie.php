...
<?php
    ...
    echo ('<h2 class="mb-3" >最高評分電影</h2>');
    $movieTop20Id = []; 
    $a = curl('http://api.themoviedb.org/3/movie/top_rated?api_key=408db82bcb709e53e2a0c72c20c6108b&language=zh-TW');
